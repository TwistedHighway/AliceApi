...
using AliceApi.Models.Entities;
using AliceApi.Services.Paging;
using AliceApi.Helpers;
using System.Data.SqlClient;

namespace AliceApi.Models.Repository
{
    /// <summary>
    ...
    public class NLogRepository : ILogReportingRepository
    {
        ...
        public void ClearLog(DateTime start, DateTime end, string[] logLevels)
        {
            ...
            //context.ExecuteStoreCommand(commandText, paramStartDate, paramEndDate, paramLogLevelList);
