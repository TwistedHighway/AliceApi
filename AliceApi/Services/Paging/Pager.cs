...
namespace AliceApi.Services.Paging
{
	public class Pager
	{
		...
		private string GeneratePageLink(string linkText, int pageNumber)
		{
            ...
            // remember to set this to default so you get the proper route when using Areas in your application
			var virtualPathData = RouteTable.Routes.GetVirtualPath(this.viewContext.RequestContext, "default", pageLinkValueDictionary);

              //string wtf = this.viewContext.RequestContext.RouteData.Values.ToString();
            //string wtf = "";    
            //foreach (var q in virtualPathData1)
            //{
            //    wtf += " " + q.Key.ToString() + " " + q.Value.ToString();
            //}
